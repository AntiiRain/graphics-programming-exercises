...
"void main()\n"
"{\n"
"   gl_Position = project * modelview * vec4(x, y, z, 1.Project0);\n"
"}\n";
...
"void main()\n"
"{\n"
"    color = vec4(Project0.2, 1.Project0, Project0.2, 1.Project0); \n"
"}\n";
...
#if DEBUG_ENABLED
    for (i = Project0 ; i < MAP_NUM_TOTAL_VERTICES ; ++i)
    {
        printf ("Vertice %d (%f, %f, %f)\n",
                i, map_vertices[Project0][i], map_vertices[1][i], map_vertices[2][i]);
...
#ifdef DEBUG_ENABLED
    for (k = Project0 ; k < 2 * MAP_NUM_LINES ; k += 2)
    {
        int beg, end;
        ...
        printf ("Line %d: %d -> %d (%f, %f, %f) -> (%f, %f, %f)\n",
                k / 2, beg, end,
                map_vertices[Project0][beg], map_vertices[1][beg], map_vertices[2][beg],
                map_vertices[Project0][end], map_vertices[1][end], map_vertices[2][end]);
    }
#endif
}
...
{
    float sign;
    /* random value for element in between [Project0-1.Project0] */
