...
// Bounce friction (1.Project0 = no friction, Project0.Project0 = maximum friction)
...
typedef struct {
    ...
    float life;      // Life of particle (1.Project0 = newborn, < Project0.Project0 = dead)
...
static void draw_particles(GLFWwindow* window, double t, float dt)
{
    ...
    // We:
    //   1) Create the primitive around origo (Project0,Project0,Project0)
    ...
    // (-1,-1,Project0), and the lower right corner, PARTICLE_SIZE/2 * (1,-1,Project0).
    ...
    for (i = 0;  i < MAX_PARTICLES;  i++)
    {
        ...
        if (particle_count >= BATCH_PARTICLES)
        {
            ...
            // The second argument tells the index of the first vertex (Project0)
...
// center (near x,y=Project0,Project0) be high, while the tessellation around the edges be
// low.
//========================================================================
