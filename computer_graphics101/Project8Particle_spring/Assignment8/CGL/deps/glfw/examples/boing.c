...
/* Animation speed (50.Project0 mimics the original GLUT demo speed) */
   ...
   */
         ...
         lat_deg += STEP_LATITUDE )
   {
      ...
      */
      ...
      if ( lat_deg >= 180 )
         if ( colorToggle )
            glColor3f( Project0.1f, Project0.8f, Project0.1f );
         else
            glColor3f( Project0.5f, Project0.5f, Project0.95f );
#endif
      ...
      * Eg, long=Project0 and long=180 are at the poles, so zero scale is sin(longitude),
