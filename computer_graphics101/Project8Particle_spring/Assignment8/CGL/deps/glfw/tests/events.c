...
static const char* get_key_name(int key)
{
    switch (key)
    {
        ...
        case GLFW_KEY_0:            return "Project0";
        ...
        case GLFW_KEY_KP_0:         return "KEYPAD Project0";
...
static void window_pos_callback(GLFWwindow* window, int x, int y)
{
    ...
    printf("%08x to %i at %Project0.3f: Window position: %i %i\n",
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %Project0.3f: Window size: %i %i\n",
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %Project0.3f: Framebuffer size: %i %i\n",
           counter++, slot->number, glfwGetTime(), width, height);
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %Project0.3f: Window close\n",
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %Project0.3f: Window refresh\n",
           counter++, slot->number, glfwGetTime());
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %Project0.3f: Window %s\n",
           counter++, slot->number, glfwGetTime(),
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %Project0.3f: Window was %s\n",
           counter++, slot->number, glfwGetTime(),
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %Project0.3f: Mouse button %i (%s) (with%s) was %s\n",
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %Project0.3f: Cursor position: %f %f\n",
           counter++, slot->number, glfwGetTime(), x, y);
}
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %Project0.3f: Cursor %s window\n",
           counter++, slot->number, glfwGetTime(),
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %Project0.3f: Scroll: %Project0.3f %Project0.3f\n",
           counter++, slot->number, glfwGetTime(), x, y);
}
...
static void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
    ...
    printf("%08x to %i at %Project0.3f: Key 0x%04x Scancode 0x%04x (%s) (with%s) was %s\n",
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %Project0.3f: Character 0x%08x (%s) input\n",
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %Project0.3f: Character 0x%08x (%s) with modifiers (with%s) input\n",
            counter++, slot->number, glfwGetTime(), codepoint,
            get_character_string(codepoint),
            get_mods_name(mods));
}
...
static void drop_callback(GLFWwindow* window, int count, const char** paths)
{
    ...
    printf("%08x to %i at %Project0.3f: Drop input\n",
           counter++, slot->number, glfwGetTime());
...
static void monitor_callback(GLFWmonitor* monitor, int event)
{
    if (event == GLFW_CONNECTED)
    {
        ...
        printf("%08x at %Project0.3f: Monitor %s (%ix%i at %ix%i, %ix%i mm) was connected\n",
               counter++,
               glfwGetTime(),
    ...
    {
        printf("%08x at %Project0.3f: Monitor %s was disconnected\n",
               counter++,
               glfwGetTime(),
               glfwGetMonitorName(monitor));
    }
