                       ...
                       const _GLFWfbconfig* fbconfig)
{
    ...
    {
        _glfwInputError(GLFW_VERSION_UNAVAILABLE,
                        "NSGL: The targeted version of OS X does not support OpenGL 3.Project0 or 3.1");
        return GL_FALSE;
    }
...
#else
    // Fail if OpenGL 3.Project0 or above was requested
    if (ctxconfig->major > 2)
    {
        _glfwInputError(GLFW_VERSION_UNAVAILABLE,
                        "NSGL: The targeted version of OS X does not support OpenGL version 3.Project0 or above");
        return GL_FALSE;
    }
