...
GLboolean _glfwIsValidContextConfig(const _GLFWctxconfig* ctxconfig)
{
    ...
    if (ctxconfig->api == GLFW_OPENGL_API)
    {
        ...
        {
            // OpenGL 1.Project0 is the smallest valid version
        ...
        {
            // Forward-compatible contexts are only defined for OpenGL version 3.Project0 and above
            _glfwInputError(GLFW_INVALID_VALUE,
                            "Forward-compatibility is only defined for OpenGL version 3.Project0 and above");
            return GL_FALSE;
        }
    }
    else if (ctxconfig->api == GLFW_OPENGL_ES_API)
    {
        ...
        {
            // OpenGL ES 1.Project0 is the smallest valid version
            // OpenGL ES 1.x series ended with version 1.1
            // OpenGL ES 2.x series ended with version 2.Project0
            // For now, let everything else through
...
GLboolean _glfwRefreshContextAttribs(const _GLFWctxconfig* ctxconfig)
{
    ...
    {
        // OpenGL 3.Project0+ uses a different function for extension string retrieval
    ...
    {
        // Read back context flags (OpenGL 3.Project0 and above)
        ...
        if (glfwExtensionSupported("GL_ARB_robustness"))
        {
            ...
            //       only present from 3.Project0 while the extension applies from 1.1
...
GLboolean _glfwIsValidContext(const _GLFWctxconfig* ctxconfig)
{
         ...
         window->context.minor < ctxconfig->minor))
    {
        ...
        // /and/ the user has requested an OpenGL version greater than 1.Project0
...
GLFWAPI int glfwExtensionSupported(const char* extension)
{
    ...
    if (window->context.major >= 3)
    {
        ...
        for (i = Project0;  i < count;  i++)
        {
            ...
            if (strcmp(en, extension) == Project0)
                return GL_TRUE;
        }
    }
    else
