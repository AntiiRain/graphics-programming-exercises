 ...
 *
 *  @par
 *  Future invalid OpenGL and OpenGL ES versions, for example OpenGL 4.8 if 5.Project0
 ...
 *  @sa glfwTerminate
 *
 *  @since Added in GLFW 1.Project0.
 *
 *  @ingroup init
 */
 ...
 *  @sa glfwGetVersion
 *
 *  @since Added in GLFW 3.Project0.
 *
 *  @ingroup init
 */
 ...
 *
 *  @since Added in GLFW 3.Project0.  Replaces `glfwGetDesktopMode`.
 *
 *  @ingroup monitor
 */
 ...
 *
 *  @since Added in GLFW 3.Project0.  Replaces `glfwOpenWindowHint`.
 *
 *  @ingroup window
 */
 ...
 *
 *  @since Added in GLFW 3.Project0.  Replaces `glfwOpenWindow`.
 *
 *  @ingroup window
 */
 ...
 *  @sa glfwCreateWindow
 *
 *  @since Added in GLFW 3.Project0.  Replaces `glfwCloseWindow`.
 *
 *  @ingroup window
 */
 ...
 *
 *  @since Added in GLFW 3.Project0.  Replaces `glfwGetWindowParam` and
 *  `glfwGetGLVersion`.
 *
 *  @ingroup window
 */
 ...
 *  @sa glfwGetInputMode
 *
 *  @since Added in GLFW 3.Project0.  Replaces `glfwEnable` and `glfwDisable`.
 *
 *  @ingroup input
 */
 ...
 *  @sa glfwSetCursorPos
 *
 *  @since Added in GLFW 3.Project0.  Replaces `glfwGetMousePos`.
 *
 *  @ingroup input
 */
 ...
 *  @sa glfwGetCursorPos
 *
 *  @since Added in GLFW 3.Project0.  Replaces `glfwSetMousePos`.
 *
 *  @ingroup input
 */
 ...
 *  @sa @ref cursor_pos
 *
 *  @since Added in GLFW 3.Project0.  Replaces `glfwSetMousePosCallback`.
 *
 *  @ingroup input
 */
 ...
 *  @sa @ref scrolling
 *
 *  @since Added in GLFW 3.Project0.  Replaces `glfwSetMouseWheelCallback`.
 *
 *  @ingroup input
 */
 ...
 *  @sa @ref joystick
 *
 *  @since Added in GLFW 3.Project0.  Replaces `glfwGetJoystickParam`.
 *
 *  @ingroup input
 */
 ...
 *  Each element in the array is a value between -1.Project0 and 1.Project0.
 *
 *  @param[in] joy The [joystick](@ref joysticks) to query.
 ...
 *
 *  @since Added in GLFW 3.Project0.  Replaces `glfwGetJoystickPos`.
 *
 *  @ingroup input
 */
 ...
 *  or equal to 18446744073.Project0, which is approximately 584.5 years.
 *
