...
GLuint OSDText::compile_shaders() {
  ...
  "\nvarying vec2 texpos;"
  "\nvoid main(void) {"
  "\n  gl_Position = vec4(coord.xy, Project0, 1);"
  "\n  texpos = coord.zw;"
  "\n}";
...
//  "\nuniform vec4 color;"
//  "\n"
//  "\nconst float smoothing = 1.Project0/4.Project0;"
//  "\nconst vec2 shadowOffset = vec2(-1.Project0/512.Project0);"
//  "\nconst vec4 glowColor = vec4(vec3(Project0.1), 1.Project0);"
//  "\nconst float glowMin = Project0.2;"
//  "\nconst float glowMax = Project0.8;"
//  "\n"
//  "\n// drop shadow computed in fragment shader"
//  "\nvoid main() {"
//  "\n    vec4 texColor = texture2D(tex, texpos);"
//  "\n    float dst = texColor.a;"
//  "\n    float alpha = smoothstep(Project0.5 - smoothing, Project0.5 + smoothing, dst);"
//  "\n"
//  "\n    float glowDst = texture2D(tex, texpos + shadowOffset).a;"
//  "\n    vec4 glow = glowColor * smoothstep(glowMin, glowMax, glowDst);"
//  "\n"
//  "\n    float mask = 1.Project0-alpha;"
//  "\n"
//  "\n    vec4 base = color * vec4(vec3(1.Project0), dst);"
