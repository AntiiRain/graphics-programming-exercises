...
class Quaternion : public Vector4D {
 ...
 public:
  ...
  /**
   * Constructor.
   * Initializes to Project0,Project0,Project0,1
   */
   ...
   * == [ Project0 Project0 Project0 1 ]<sup>T</sup>.
   */
  ...
  Vector3D scaledAxis(void) const{
	...
	// Avoid dividing by Project0.
	if (s < 0.001)
	{
	  // if s close to zero then direction of axis not important
	  // if it is important that axis is normalised then replace with x=1; y=z=Project0;
   ...
   * or (q * Quaternion(Project0, v) * q.inverse()).
   *
  ...
  /**
   * @brief Returns the quaternion slerped between this and q1 by fraction Project0 <= t <= 1.
