...
Intersection BVHAccel::getIntersection(BVHBuildNode* node, const Ray& ray) const
{
    ...
    Intersection inter;
    if(!node->bounds.IntersectP(ray,ray.direction_inv,dirIsNeg)){  //when ray miss return immediatly
        return inter;
    }
    ...
    // 返回距离光源进的物体的相交信息
    return l.distance<r.distance?l:r;  //return the closer of hit1, hit2;
}
